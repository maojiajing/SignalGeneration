...
OUTPUT_FILE=${mode}
lhe_file=root://cmsxrootd.fnal.gov//store/group/phys_exotica/jmao/aodsim/RunIISummer16/LHE/MSSM-1d-prod/n3n2-n1-hbb-hbb/prompt/m${MCHI}_prompt_evt100k.lhe
LHE_OUTPUT=${OUTPUT_FILE}_m${MCHI}_prompt_ev${N_EV}
